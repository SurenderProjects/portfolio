...
export default function Hero() {
    const config  = {
        ...
        social: {
            twitter: 'https://x.com/SURENTHIRAN0828',
            github: 'https://github.com/SurenderProjects',
            linkedin: 'https://www.linkedin.com/in/surenthiran-e-a24451217'
        }
    }
    ...
    return <section className='flex flex-col md:flex-row px-5 py-32 bg-primary justify-center'>
       <div className='md:w-1/2 flex flex-col'>
            <h1 className=' text-white text-6xl font-hero-font'>Hi, <br/> Im <span className='text-black'>E</span> SURENTHIRAN 
